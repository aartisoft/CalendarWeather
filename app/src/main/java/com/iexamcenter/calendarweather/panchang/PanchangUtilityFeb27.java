...
public class PanchangUtilityFeb27 {
    ...
    public MyPanchang getMyPunchang(CoreDataHelper coreDataObj, String lang, int calType, String latStr, String lngStr, Context context, int year, int month, int day) {
        try {
          ...
          //  myPanchangObj.le_day = myPanchangObj.eday = "" + day;
            myPanchangObj.dayOfWeek = dayOfWeek;
            myPanchangObj.le_month = le_arr_month[month];
          //  myPanchangObj.emonth = le_arr_month[month];
          //  myPanchangObj.le_year = myPanchangObj.eyear = "" + year;
          ...
          //  myPanchangObj.echandrashuddhi = geteChandraShuddhi(moonSignObj);
            ...
            if (puskarObj.currVal != 0) {
                ...
                ecurrPuskar = puskarObj.currVal + le_pada;
          ...
          //  myPanchangObj.epaksha = le_arr_pakshya[paksha];
          ...
          //  myPanchangObj.etithi[2] = setMySubPanchang(enextToNextTithi, "");
            ...
            if (!ecurrJoginiYatra.isEmpty())
                ecurrJoginiYatra = ecurrJoginiYatra + " " + le_jogin_help;
            ...
            if (!enextJoginiYatra.isEmpty())
                enextJoginiYatra = enextJoginiYatra + " " + le_jogin_help;
            ...
            if (!enextToNextJoginiYatra.isEmpty())
                enextToNextJoginiYatra = enextToNextJoginiYatra + " " + le_jogin_help;
         ...
         //   myPanchangObj.esamvata = samvata;
          ...
          //  myPanchangObj.esanSal = sanSala;
            ...
            String ek1 = le_arr_karana[karanaObj.val1 - 1];
            ...
            if (karanaObj.val2 != 0) {
                ...
                ek2 = le_arr_karana[karanaObj.val2 - 1];
            }
            if (karanaObj.val3 != 0) {
         ...
         //   myPanchangObj.enakshetra[2] = setMySubPanchang(enextToNextNakshetra, "");
            ...
            String ecurrJoga = le_arr_joga[jogaObj.currVal - 1];
            ...
            if (jogaObj.nextVal != 0) {
                ...
                enextJoga = le_arr_joga[jogaObj.nextVal - 1];
            }
            if (jogaObj.nextToNextVal != 0) {
                ...
                enextToNextJoga = le_arr_joga[jogaObj.nextToNextVal - 1];
            }
         ...
         //   myPanchangObj.ejoga[2] = setMySubPanchang(enextToNextJoga, "");
            ...
            String ecurrSunSign = le_arr_rasi_kundali[sunSignObj.currVal - 1];
            String enextSunSign = "";
            ...
            if (adjustSolarMonth >= 3 && adjustSolarMonth < 9) {
              ...
              //  myPanchangObj.eAyana = le_dayana;
            } else {
                myPanchangObj.le_ayana = le_uayana;
               // myPanchangObj.eAyana = le_uayana;
            }
    ...
    private String geteChandraShuddhi(CoreDataHelper.Panchanga moonsignObj) {
        ...
        chandrashuddhi = chandrashuddhi.trim().replaceAll(",$", "");
        chandrashuddhi = chandrashuddhi + " " + le_time_to + " " + geteFormattedDate(moonsignObj.currValEndTime) + " ";
    ...
    private String geteTaraShuddhi(CoreDataHelper.Panchanga nakshetraObj) {
        ...
        nakshetra = nakshetra + " " + le_time_to + " " + geteFormattedDate(nakshetraObj.currValEndTime) + " ";
...
*  <item>ପୂର୍ବ ଦିଗେ</item>
    ...
    public class MyPanchang {
        ...
        public String erajaDarsan, le_rajaDarsan, le_samvata, esamvata, ecurrTithi, currTithi, le_chandrashuddhi, echandrashuddhi, le_tarashuddhi, etarashuddhi, auspKey, le_sanSal, le_sakaddha, le_paksha, le_sunRise, le_sunSet, le_moonRise, le_moonSet, le_bara, le_day, le_month, le_year, le_sunTransit, le_midNight, le_dayLength, le_nightLength;
        ...
        public String lunarDayAmant, lunarMonthAmant, le_lunarDayPurimant, le_lunarMonthPurimant, le_solarDay, le_solarMonth;

        public String le_sanSalAnka, esanSal, esakaddha, epaksha, esunRise, esunSet, emoonRise, emoonSet, ebara, eday, emonth, eyear, esunTransit, emidNight, edayLength, enightLength;
        ...
        public String eghataBar, le_ghataBar, eRitu, eAyana, le_ritu, le_ayana, eshraddha, le_shraddha, elunarDayAmant, elunarMonthAmant, elunarDayPurimant, elunarMonthPurimant, esolarDay, esolarMonth;
