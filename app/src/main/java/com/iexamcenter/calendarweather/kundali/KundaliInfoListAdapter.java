...
public class KundaliInfoListAdapter extends RecyclerView.Adapter<KundaliInfoListAdapter.ItemViewHolder> {
    Context mContext;
    String[] eplanetList, lplanetList, planetList, lrashiList, rashiList;
    ArrayList<KundaliInfoFrag.PlanetData> planetDataList;

    public KundaliInfoListAdapter(Context context, ArrayList<KundaliInfoFrag.PlanetData> planetDataList) {
        mContext = context;
    ...
    public void onBindViewHolder(final ItemViewHolder holder, int position) {
        ...
        KundaliInfoFrag.PlanetData obj = planetDataList.get(position);
        //   String txt1 = obj.planet ;//+ "(" + obj.houseNo + ")";
        //  String txt2 = obj.latLng1;
        // String txt3 = "" + obj.deg;
