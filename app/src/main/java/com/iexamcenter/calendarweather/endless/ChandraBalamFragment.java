...
import com.iexamcenter.calendarweather.panchang.ChandraBalamListAdapter;
...
public class ChandraBalamFragment extends Fragment {
    public static final String ARG_POSITION = "ARG_POSITION";

    public static boolean active = false;
    ChandraBalamListAdapter mPanchangAdapter;
    ...
    public static Fragment newInstance() {
        return new ChandraBalamFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPanchangAdapter = new ChandraBalamListAdapter(mContext, mDayViewHashMap, monthFestivalmap, displayMonthInt, displayYearInt, displayDayInt, pagePos);
