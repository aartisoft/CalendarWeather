...
import com.iexamcenter.calendarweather.panchang.HoraMuhurtaListAdapter;
...
public class HoraMuhurtaFragment extends Fragment {
    public static final String ARG_POSITION = "ARG_POSITION";

    public static boolean active = false;
    HoraMuhurtaListAdapter mPanchangAdapter;
    ...
    public static Fragment newInstance() {
        return new HoraMuhurtaFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPanchangAdapter = new HoraMuhurtaListAdapter(mContext, mDayViewHashMap, monthFestivalmap, displayMonthInt, displayYearInt, displayDayInt, pagePos);
