...
public class AuspWorkFragmentBck1 extends Fragment {
    ...
    public static Fragment newInstance() {
        return new AuspWorkFragmentBck1();
    }
            ...
            try {
                ...
                for (int i = 0; i < auspData.size(); i++) {
                   ...
                   /* boolean isNakshetra1 = dataObj.getNakshetra().contains("|" + nakshetra1 + "|");
                    ...
                    ArrayList<String> goodTimeTithi = new ArrayList<>();
                    ArrayList<String> goodTimeNakshetra = new ArrayList<>();
                    ArrayList<String> goodTimeKarana = new ArrayList<>();
                    ArrayList<String> goodTimeJoga = new ArrayList<>();
                    goodTimeTithi.addAll(goodTimeTithi(myCoreData, dataObj));

                    goodTimeNakshetra.addAll(goodTimeNakshetra(myCoreData, dataObj));
                    goodTimeKarana.addAll(goodTimeKarana(myCoreData, dataObj));
                    goodTimeJoga.addAll(goodTimeJoga(myCoreData, dataObj));
                    ...
                    Log.e("ArrayList", "GOODTIME:INTERSECTION:DAY" + goodTimeTithi.size());
...
//&& tithi1Duration > 4
    ...
    private ArrayList<String> getGoodTime(Calendar sunriseTime, Calendar startTime, Calendar endTime) {
        ...
        //   Calendar sunriseTime = myCoreData.getSunRiseCal();
        //  Calendar startTime = myCoreData.getSunRiseCal();
        //  Calendar endTime = myCoreData.getJoga().currValEndTime;

        // int day1 = sunriseTime.get(Calendar.DAY_OF_MONTH);
    ...
    private ArrayList<String> goodTimeNakshetra(CoreDataHelper myCoreData, AuspData dataObj) {
        ...
        Log.e("ArrayList", "GOODTIME:NAKSHETRA:" + settingStr);
        if (settingStr.contains("|" + currVal + "|")) {
            al.addAll(getGoodTime(myCoreData.getSunRiseCal(), myCoreData.getSunRiseCal(), mainObj.currValEndTime));
            goodTime = true;
        }
        ...
        Log.e("ArrayList", "GOODTIME:NAKSHETRA:" + al.size());
        for (int i = 0; i < al.size(); i++) {
            Log.e("ArrayList", "GOODTIME:NAKSHETRA:" + al.get(i));
        }
    ...
    private ArrayList<String> goodTimeTithi(CoreDataHelper myCoreData, AuspData dataObj) {
        ...
        Log.e("ArrayList", "GOODTIME:TITHI:" + settingStr);
        if (settingStr.contains("|" + currVal + "|")) {
            al.addAll(getGoodTime(myCoreData.getSunRiseCal(), myCoreData.getSunRiseCal(), mainObj.currValEndTime));
            goodTime = true;
        }
