...
import com.iexamcenter.calendarweather.panchang.ChoghadiyaListAdapter;
...
public class ChoghadiyaFragment extends Fragment {
    public static final String ARG_POSITION = "ARG_POSITION";

    public static boolean active = false;
    ChoghadiyaListAdapter mPanchangAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPanchangAdapter = new ChoghadiyaListAdapter(mContext, mDayViewHashMap, monthFestivalmap, displayMonthInt, displayYearInt, displayDayInt, pagePos);
