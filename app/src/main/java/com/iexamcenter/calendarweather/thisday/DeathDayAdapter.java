...
public class DeathDayAdapter extends RecyclerView.Adapter<DeathDayAdapter.ItemViewHolder> {
    Resources res;
    MainActivity mContext;
    ArrayList<ThisDayResponse.DEATHDAY> mItems;
    private int lastPosition = -1;
    int mPage = 0;
    PrefManager mPref;
    public DeathDayAdapter(MainActivity context, ArrayList<ThisDayResponse.DEATHDAY> pglist, int page) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ItemViewHolder vh = new ItemViewHolder(view, new DeathDayAdapter.ItemViewHolder.IMyViewHolderInterface() {

            @Override
            public void details(View v) {
                ThisDayResponse.DEATHDAY obj = (ThisDayResponse.DEATHDAY) v.getTag();
               // obj.
    ...
    public void onBindViewHolder(final ItemViewHolder holder, int position) {
        final ThisDayResponse.DEATHDAY obj = mItems.get(position);
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        DeathDayAdapter.ItemViewHolder.IMyViewHolderInterface mListener;
